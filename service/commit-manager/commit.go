...
func (manage *CommitManager) GetCommits(repoName, owner string) {
...
func (manage *CommitManager) UpdateCommitEveryHour() {
	...
	job := func() {
		...
		for _, details := range repoDetails {
			...
			go manage.GetCommits(details.Name, details.Owner)
		}
	}
